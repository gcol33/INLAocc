...
Thank you for your interest in contributing to INLAocc! This document outlines how to get started.
...
3. Run `devtools::test()` and `devtools::check()`
4. Submit a pull request with a clear description

## Style Guidelines

- R functions: camelCase for exports (e.g., `occu_inla`, `ppcOccu`)
- Arguments: dot.case following spOccupancy conventions (e.g., `occ.formula`, `det.covs`)
