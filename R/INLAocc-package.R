...
#' @importFrom stats as.formula binomial coef confint cor glm model.matrix nobs
#'   pnorm prcomp predict qnorm quantile rbeta rbinom rnorm runif sd terms
#'   update update.formula var vcov dist setNames lm
